...
Landed in Trieste, Italy right at the border of Slovenia and drove into the mountains and spent the first night in a charming alpine town. 
...
{% include photo.html src="soca-gorge-2.jpg" caption="On the Soča Gorge trail." %}
...
After the hike, made our way through to Lake Bohinj - an incredible lake nestled in the mountains. 

{% include photo-pair.html src1="bohinj-1.jpg" caption1="Howdy." src2="bohinj-2.jpg" caption2="A little chilly for a plunge." %}

{% include photo-pair.html src1="bohinj-3.jpg" caption1="Gorgeous view from the hotel." src2="bohinj-4.jpg" caption2="Michelin dining at Majer'ca." %}
